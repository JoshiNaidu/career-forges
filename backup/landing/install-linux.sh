...
# ==========================================
# Model Selection
# Echoes chosen model name on stdout.
# All prompts/display go to stderr.
# ==========================================
select_model() {

    mapfile -t installed < <(get_installed_models)

    # ---- Offer reuse if models already present ----
...
if [ -z "$DOWNLOAD_URL" ]; then
    err "Unable to locate AppImage asset in the latest release."
    exit 1
fi
