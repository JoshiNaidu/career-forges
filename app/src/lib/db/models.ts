...
export interface BackgroundTask {
  id: string;
  taskType: 'resume_generation' | 'cover_letter_generation' | 'job_fetch' | 'resume_parsing' | 'interview_analysis' | 'download' | 'update' | 'other';
  status: 'pending' | 'running' | 'completed' | 'failed' | 'cancelled' | 'retry';
  label: string;
  entityType?: string;
  entityId?: string;
  progress: number;
