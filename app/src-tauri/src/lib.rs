...
.invoke_handler(tauri::generate_handler![
    ...
    db_create_background_task,
    db_get_background_task,
    db_list_background_tasks_by_status,
    db_list_recent_background_tasks,
    db_list_background_tasks_by_entity,
    db_update_background_task_status,
    db_update_background_task_progress,
    db_cancel_background_task,
    db_retry_background_task,
    db_delete_background_task,
    db_count_background_tasks_by_status,
])
